...
@course_api.route('', methods=['POST', 'GET'])
@api_authorizer()
def get_courses(user):
    ...
    errors, courses_paginated = application.course.get_all(filters, {
    ...
    return Response(json.dumps(courses_paginated, default=str), status=200)
