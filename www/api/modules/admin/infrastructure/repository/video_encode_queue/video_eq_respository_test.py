...
from api.modules.admin.domain.entity import VideoEncodingQueueModel, VideoEncodingQueueStatus
from api.modules.admin.infrastructure.repository import VideoEQRepository


class TestVideoEQRepository(unittest.TestCase):
    repo_location = 'api.modules.admin.infrastructure.repository'
    mock_db_engine = Mock()
